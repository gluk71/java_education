...
public class Phonebook {
    ...
    //FindSname - производит поиск фамилии по номеру телефона заданому в качестве аргумента
    //возвращает строку
    public static String FindSname(String number){
    ...
    public static String[] FindNumberPhone(String sname){
        List <String> result = new ArrayList<String>();
        for (Map.Entry entry : pb.entrySet()) {
            if (sname.equalsIgnoreCase((String)entry.getValue())){
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("выбор действия: (add)добавить данные, (num) найти номера по фамилии, (sur)найти фамилию, " +
            ...
            if(act.equals("add")){
                ...
                if(act.equals("del")){
                    ...
                    if (act.equals("num")){
                        ...
                        String[] numbers = FindNumberPhone(sname);
